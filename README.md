...
- 🌱 I’m currently studing C++, Java and Lexical Analysis (<-- two spaces)
![alt text](https://upload.wikimedia.org/wikipedia/it/thumb/2/2e/Java_Logo.svg/322px-Java_Logo.svg.png) (<-- two spaces)
